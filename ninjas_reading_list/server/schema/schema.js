...
//   {id: '5', name: 'The Colours of Magic', genre: 'Fantasy', authorId: '2'},
//   {id: '6', name: 'The Light Fantastic', genre: 'Fantasy', authorId: '1'}
// ]
    ...
    addBook: {
      ...
      resolve(parent, args){
        let book = new Book({
          name: args.name,
          genre: args.genre,
          authorId: args.authorId // TODO: this doesnot work 
        });
        return book.save();
      }
    }
